...
// イベント処理
var e=this;this.$stopButton=this.$uploadInfoRow.find(f.stopButton),this.$deleteButton=this.$uploadInfoRow.find(f.deleteButton),this.$stopButton&&this.$stopButton.on("click",function(){f.stopCallBack.call(e)}),this.$deleteButton&&this.$deleteButton.on("click",function(){e.fileId&&(a.ajax({url:f.deleteUrl+"/"+e.fileId,cache:!1,method:"delete"}).done(function(){f.doneDeleteCallBack.call(e)}).fail(function(a,b,c){f.failDeleteCallBack.call(e,a,b,c)}),e.$deleteButton&&e.$deleteButton.hide())})};i.prototype.start=function(){var c=this;f.startUploadCallBack.call(c);var d=a.extend({xhr:function(){var a=new b.XMLHttpRequest;
// アップロードの進捗
// 中止の場合
return a.upload.addEventListener("progress",function(a){c.progress.call(c,a)},!1),a.addEventListener("abort",function(a){c.abort.call(c,a)},!1),a},url:f.url,data:c.formData},h);c.ajax=a.ajax(d).done(function(a){f.doneUploadCallBack.call(c,a),c.ajax=null}).fail(function(a,b,d){f.failUploadCallBack.call(c,a,b,d),c.ajax=null})},/**
   * アップロード処理中のコールバック。<br>
   * アップロードしたサイズを記録する。
   * @param event イベント
   */
