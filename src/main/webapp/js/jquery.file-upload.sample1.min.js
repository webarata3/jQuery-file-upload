...
// アップロードの進捗
// 中止の場合
return a.upload.addEventListener("progress",function(a){b.progress.call(b,a)},!1),a.addEventListener("abort",function(a){b.abort.call(b,a)},!1),a},url:g.url,data:b.formData},i);b.ajax=a.ajax(d).done(function(a){g.doneUploadCallBack.call(b,a),b.ajax=null}).fail(function(a,c,d){g.failUploadgrCallBack.call(b,a,c,d),b.ajax=null})},/**
   * アップロード処理中のコールバック。<br>
   * アップロードしたサイズを記録する。
   * @param event イベント
   */
