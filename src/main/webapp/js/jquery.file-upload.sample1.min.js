...
// イベント処理
var e=this;if(this.$stopButton=this.$uploadInfoRow.find(g.stopButton),this.$deleteButton=this.$uploadInfoRow.find(g.deleteButton),this.$stopButton&&this.$stopButton.on("click",function(){g.stopCallBack.call(e)}),this.$deleteButton){var e=this;this.$deleteButton.on("click",function(){e.fileId&&(a.ajax({url:g.deleteUrl+"/"+e.fileId,cache:!1,method:"delete"}).done(function(){g.doneDeleteCallBack.call(e)}).fail(function(a,b,c){g.failDeleteCallBack.call(e)}),e.$deleteButton&&e.$deleteButton.hide())})}};j.prototype.start=function(){var b=this,d=a.extend({xhr:function(){var a=new c.XMLHttpRequest;
// アップロードの進捗
// 中止の場合
