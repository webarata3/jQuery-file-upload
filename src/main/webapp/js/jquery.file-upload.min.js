...
// イベント処理
var e=this;this.$stopButton=this.$uploadInfoRow.find(f.stopButton),this.$deleteButton=this.$uploadInfoRow.find(f.deleteButton),this.$stopButton&&this.$stopButton.on("click",function(){f.stopCallBack.call(e)}),this.$deleteButton&&this.$deleteButton.on("click",function(){f.deleteCallBack.call(e)})};i.prototype.start=function(){var b=this,c=a.extend({xhr:function(){var a=new global.XMLHttpRequest;
// アップロードの進捗
// 中止の場合
return a.upload.addEventListener("progress",function(a){b.progress.call(b,a)},!1),a.addEventListener("abort",function(a){b.abort.call(b,a)},!1),a},url:f.url,data:b.formData},h);b.ajax=a.ajax(c).done(function(a){f.doneCallBack.call(b,a),b.ajax=null}).fail(function(a,c,d){f.failCallBack.call(b,a,c,d),b.ajax=null})},/**
   * アップロード処理中のコールバック。<br>
   * アップロードしたサイズを記録する。
   * @param event イベント
   */
